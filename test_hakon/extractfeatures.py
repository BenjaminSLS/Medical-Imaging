...
def extract_features(image,mask):
    ...
    diagnostic = np.nan
    return np.array([diagnostic,area, perimeter, compactness, rotation_asymmetry, asymmetry, hue_sd, sat_sd, val_sd])
...
def get_color(image):
    ...
    segments_slic = slic(image, n_segments=250,compactness=20, start_label=1, sigma=3)
